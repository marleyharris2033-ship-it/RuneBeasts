...
const TYPES={Fire:{strong:"Grass",weak:"Water"},Grass:{strong:"Water",weak:"Fire"},Water:{strong:"Fire",weak:"Grass"},Electric:{strong:"Flying",weak:"Rock"},Flying:{strong:"Rock",weak:"Electric"},Rock:{strong:"Electric",weak:"Flying"},Ice:{strong:"Flying",weak:"Fire"},Spirit:{strong:"Rock",weak:"Shadow"},Shadow:{strong:"Spirit",weak:"Electric"}};
...
const EXTRA_BEASTS=[{"id":"scorchling","name":"Scorchling","type":"Fire","rarity":"Common","role":"Speed","base":[36,42,32,42,34,62],"glyph":"◆"},{"id":"brookotter","name":"Brookotter","type":"Water","rarity":"Common","role":"Balanced","base":[45,45,45,45,45,45],"glyph":"◆"},{"id":"leafennec","name":"Leafennec","type":"Grass","rarity":"Uncommon","role":"Speed","base":[44,50,40,50,42,70],"glyph":"◆"},{"id":"voltjack","name":"Voltjack","type":"Electric","rarity":"Uncommon","role":"Special","base":[49,41,45,71,57,57],"glyph":"◆"},{"id":"russetwing","name":"Russetwing","type":"Flying","rarity":"Common","role":"Balanced","base":[44,44,44,44,44,44],"glyph":"◆"},{"id":"tuskember","name":"Tuskember","type":"Fire","rarity":"Uncommon","role":"Physical","base":[53,67,49,37,41,49],"glyph":"◆"},{"id":"glacefox","name":"Glacefox","type":"Ice","rarity":"Rare","role":"Speed","base":[53,59,49,59,51,79],"glyph":"◆"},{"id":"petalump","name":"Petalump","type":"Grass","rarity":"Common","role":"Support","base":[53,31,43,45,61,37],"glyph":"◆"},{"id":"duskrook","name":"Duskrook","type":"Shadow","rarity":"Uncommon","role":"Special","base":[49,41,45,71,57,57],"glyph":"◆"},{"id":"rubycrag","name":"Rubycrag","type":"Rock","rarity":"Rare","role":"Defence","base":[66,52,82,50,72,38],"glyph":"◆"},{"id":"jellume","name":"Jellume","type":"Water","rarity":"Common","role":"Special","base":[38,30,34,60,46,46],"glyph":"◆"},{"id":"sunmoth","name":"Sunmoth","type":"Flying","rarity":"Uncommon","role":"Special","base":[48,40,44,70,56,56],"glyph":"◆"},{"id":"wispuff","name":"Wispuff","type":"Spirit","rarity":"Common","role":"Support","base":[53,31,43,45,61,37],"glyph":"◆"},{"id":"cloudhorn","name":"Cloudhorn","type":"Flying","rarity":"Uncommon","role":"Tank","base":[71,57,73,39,57,33],"glyph":"◆"},{"id":"cactorb","name":"Cactorb","type":"Grass","rarity":"Common","role":"Defence","base":[52,38,68,36,58,25],"glyph":"◆"},{"id":"bloomkin","name":"Bloomkin","type":"Grass","rarity":"Rare","role":"Support","base":[66,44,56,58,74,50],"glyph":"◆"},{"id":"noctbat","name":"Noctbat","type":"Shadow","rarity":"Common","role":"Speed","base":[39,45,35,45,37,65],"glyph":"◆"},{"id":"frostspike","name":"Frostspike","type":"Ice","rarity":"Rare","role":"Physical","base":[61,75,57,45,49,57],"glyph":"◆"},{"id":"rootling","name":"Rootling","type":"Grass","rarity":"Common","role":"Tank","base":[64,50,66,32,50,26],"glyph":"◆"},{"id":"shellsurge","name":"Shellsurge","type":"Water","rarity":"Uncommon","role":"Tank","base":[69,55,71,37,55,31],"glyph":"◆"},{"id":"boulderhorn","name":"Boulderhorn","type":"Rock","rarity":"Rare","role":"Physical","base":[60,74,56,44,48,56],"glyph":"◆"},{"id":"shroomling","name":"Shroomling","type":"Grass","rarity":"Common","role":"Support","base":[55,33,45,47,63,39],"glyph":"◆"},{"id":"reeforse","name":"Reeforse","type":"Water","rarity":"Common","role":"Speed","base":[37,43,33,43,35,63],"glyph":"◆"},{"id":"mosscub","name":"Mosscub","type":"Grass","rarity":"Common","role":"Tank","base":[64,50,66,32,50,26],"glyph":"◆"},{"id":"vinecoil","name":"Vinecoil","type":"Grass","rarity":"Uncommon","role":"Physical","base":[55,69,51,39,43,51],"glyph":"◆"},{"id":"frosthart","name":"Frosthart","type":"Ice","rarity":"Rare","role":"Balanced","base":[56,56,56,56,56,56],"glyph":"◆"},{"id":"miretail","name":"Miretail","type":"Water","rarity":"Common","role":"Balanced","base":[45,45,45,45,45,45],"glyph":"◆"},{"id":"stormusa","name":"Stormusa","type":"Electric","rarity":"Rare","role":"Special","base":[53,45,49,75,61,61],"glyph":"◆"},{"id":"emberbun","name":"Emberbun","type":"Fire","rarity":"Common","role":"Speed","base":[40,46,36,46,38,66],"glyph":"◆"},{"id":"runemoth","name":"Runemoth","type":"Spirit","rarity":"Uncommon","role":"Special","base":[47,39,43,69,55,55],"glyph":"◆"},{"id":"cavelisk","name":"Cavelisk","type":"Fire","rarity":"Uncommon","role":"Tank","base":[67,53,69,35,53,29],"glyph":"◆"},{"id":"reefclaw","name":"Reefclaw","type":"Water","rarity":"Uncommon","role":"Defence","base":[60,46,76,44,66,32],"glyph":"◆"},{"id":"duskmew","name":"Duskmew","type":"Shadow","rarity":"Rare","role":"Speed","base":[51,57,47,57,49,77],"glyph":"◆"},{"id":"duneback","name":"Duneback","type":"Rock","rarity":"Common","role":"Tank","base":[64,50,66,32,50,26],"glyph":"◆"},{"id":"wisptern","name":"Wisptern","type":"Spirit","rarity":"Uncommon","role":"Support","base":[61,39,51,53,69,45],"glyph":"◆"},{"id":"geodrake","name":"Geodrake","type":"Rock","rarity":"Rare","role":"Special","base":[52,44,48,74,60,60],"glyph":"◆"},{"id":"auraswan","name":"Auraswan","type":"Flying","rarity":"Rare","role":"Support","base":[69,47,59,61,77,53],"glyph":"◆"},{"id":"runeguard","name":"Runeguard","type":"Spirit","rarity":"Rare","role":"Tank","base":[75,61,77,43,61,37],"glyph":"◆"}];
BEASTS.push(...EXTRA_BEASTS);
...
Object.assign(MOVES,{
  "Frost Bite":{type:"Ice",power:45,acc:100},"Ice Shard":{type:"Ice",power:58,acc:95},"Glacier Crash":{type:"Ice",power:72,acc:85},
  "Wisp Touch":{type:"Spirit",power:45,acc:100},"Rune Pulse":{type:"Spirit",power:58,acc:95},"Soulflare":{type:"Spirit",power:72,acc:85},
  "Dusk Claw":{type:"Shadow",power:45,acc:100},"Night Rush":{type:"Shadow",power:58,acc:95},"Eclipse Wave":{type:"Shadow",power:72,acc:85}
});
...
const ATLAS_SPRITES={
  titanox:[1,6],driftfin:[1,7],slateback:[1,8],bloomhorn:[1,13],coilisk:[1,17],flarewing:[1,21],crystoad:[1,22],cragclaw:[1,23],thundram:[1,28],coalisk:[1,29],skyrake:[1,32],abyssquid:[1,33],pyrel:[1,35],stormowl:[1,36],
  gemscarab:[2,1],thornox:[2,3],arcwing:[2,5],magmole:[2,6],galehare:[2,16],cloudimp:[2,18],razorjay:[2,23],fernfox:[2,26],staticub:[2,27],tidehorn:[2,35],
  scorchling:[1,1],brookotter:[1,2],leafennec:[1,3],voltjack:[1,4],russetwing:[1,5],tuskember:[1,9],glacefox:[1,10],petalump:[1,11],duskrook:[1,12],rubycrag:[1,14],jellume:[1,15],sunmoth:[1,16],wispuff:[1,18],cloudhorn:[1,19],cactorb:[1,20],bloomkin:[1,24],noctbat:[1,25],frostspike:[1,26],rootling:[1,27],shellsurge:[1,30],boulderhorn:[1,31],shroomling:[1,34],
  reeforse:[2,2],mosscub:[2,4],vinecoil:[2,7],frosthart:[2,8],miretail:[2,9],stormusa:[2,10],emberbun:[2,11],runemoth:[2,12],cavelisk:[2,13],reefclaw:[2,14],duskmew:[2,17],duneback:[2,19],wisptern:[2,20],geodrake:[2,24],auraswan:[2,31],runeguard:[2,36]
};
const ATLAS_FILES={1:'beast_atlas_1.png',2:'beast_atlas_2.png'};
function atlasStyle(id){
  const a=ATLAS_SPRITES[id];if(!a)return null;
  const n=a[1]-1,row=Math.floor(n/6),col=n%6;
  return {src:ATLAS_FILES[a[0]],x:col*20,y:row*20,row,col};
}
...
const $=s=>document.querySelector(s), $$=s=>[...document.querySelectorAll(s)]; const beastBy=id=>BEASTS.find(b=>b.id===id); const clamp=(v,a,b)=>Math.max(a,Math.min(b,v)); const xpNeed=lv=>30+lv*20; const typeColors={Fire:'#b94b39',Water:'#3678bb',Grass:'#4e8c49',Electric:'#b69525',Flying:'#687fb8',Rock:'#786f67',Ice:'#63a7c9',Spirit:'#7656a8',Shadow:'#4a3a69',Neutral:'#596680'};
...
function defaultLearnset(type){
  const byType={
    ...
    Ice:[[1,'Scratch'],[3,'Frost Bite'],[8,'Quick Jab'],[12,'Ice Shard'],[20,'Guard Break'],[28,'Glacier Crash']],
    Spirit:[[1,'Scratch'],[3,'Wisp Touch'],[8,'Quick Jab'],[12,'Rune Pulse'],[20,'Guard Break'],[28,'Soulflare']],
    Shadow:[[1,'Scratch'],[3,'Dusk Claw'],[8,'Quick Jab'],[12,'Night Rush'],[20,'Guard Break'],[28,'Eclipse Wave']]
  };
...
function creatureArt(id,size='md'){
  const b=beastBy(id),atlas=atlasStyle(id),cls=size==='lg'?'sprite-lg':size==='sm'?'sprite-sm':'sprite-md';
  if(atlas)return `<span class="creatureImg atlasBeast ${cls}" role="img" aria-label="${b.name}" style="background-image:url('${atlas.src}');background-position:${atlas.x}% ${atlas.y}%"></span>`;
  const path=SPRITES[id],src=path?assetUrl(path):proceduralBeastSprite(id);
  return `<img class="creatureImg ${cls}" src="${src}" alt="${b.name}" loading="eager">`;
}
